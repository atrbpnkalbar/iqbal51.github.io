      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
		   ...
		   <a class="navbar-brand"> <font color = "#B0C4DE" Size="5" align="left"> SISTEM INFORMASI LP2B KALIMANTAN BARAT</font></a>	 
          <a class="navbar-brand" href="?"> <font color = "#B0C4DE" align="right"> Home </font></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <?php if($_SESSION['login']):?>
            <li><a href="?m=tempat"><span class="glyphicon glyphicon-map-marker">Peta</a></li>
            <li><a href="?m=galeri"><span class="glyphicon glyphicon-picture"></span> Galeri</a></li>            
            <li><a href="?m=password"><span class="glyphicon glyphicon-lock"></span> Password</a></li>
            <li><a href="aksi.php?act=logout"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
            <?php else:?>            
            <li><a href="?m=tempat_list"><span class="glyphicon glyphicon-map-marker"></span> Peta</a></li>
		...
		<iframe width="100%" width="480x" height="500px" src="https://atrbpnkalbar.github.io/pontianak/" frameborder="0" scrolling="no"> </iframe>
